...
async def sendreq(req: Client, que_ry: CallbackQuery):
    if que_ry.data == "sendreq":
        await req.forward_messages(-1001716483713, que_ry.message.chat.id, que_ry.message.id)
        await req.send_message(que_ry.message.chat.id, "✅ İsteğiniz yöneticiye gönderilmiştir. En kısa sürede eklenecektir. İyi günler...")
